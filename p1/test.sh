...
/usr/local/spark/bin/spark-submit --master=spark://$SPARK_MASTER:7077 ./model.py hdfs://$SPARK_MASTER:9000/part_1/input/train.csv hdfs://$SPARK_MASTER:9000/part_1/input/test.csv
